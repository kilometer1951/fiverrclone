...
GigSchema.plugin(mongooseAlgolia,{
  appId: '36APM6O217',
  apiKey: 'b48a75700ef44a242b7d8557a9001d88',
...
Model.SetAlgoliaSettings({
  searchableAttributes: ['title','owner.name','category'] //Sets the settings for this schema, see [Algolia's Index settings parameters](https://www.algolia.com/doc/api-client/javascript/settings#set-settings) for more info.
});
